...
.details {
  font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-size: 2vw;color:black;padding-top: 20px;
...
.udetails{
  ...
  <body>
      ...
      <div class="container-fluid">
            <div class="navbar1">
          <ul class="nav navbar-nav navbar-left ul2">
            ...
            <li class="li2"><a href="" style="color: #f0f9ff;">CustomerScore</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right ul2" style="padding-right: 5%;">
            <li class="li2"><a href="#" style="color: #f0f9ff;">Home</a></li>
            <li class="li2"><a href="#" style="color: #f0f9ff;">Categories</a></li>
            <li class="li2"><a href="#" style="color: #f0f9ff;">Login</a></li>
          </ul>
</div>
        </div>
...
<div class="container">
  ...
  <div id="text1" class="col-sm-8">
    ...
    <img src="pics/logo.jpg" style="max-height:100px;object-fit:cover;object-position:bottom;" /> 
    </div>
    <div class="col-sm-2" style="max-width:20%;float:left;margin:25px;">
    <div class="details">
      GITMIT
</div><p>Reviews:Number<br>
</div>
...
<span class="fa fa-star"></span>
  ...
  <div id="text3" class="col-sm-4" style="display:block;">
    ...
    <p class="Clink" style="width:80%;height:auto;width:auto\9;overflow:hidden;"><a href="#">GITMIT<br> Visit the website</a></p>
  </div>
</div>
</div>
</div>
...
<div class="Creview" style="background-color:#f1f1e8;padding-top:1%;height:auto;">
  ...
  <img src="pics/CoCo.jpg" style="width:70px;height:60px;border-radius: 50%;float:left;text-align:left;"/>
    </div>
  </div>
  <div class="col-sm-3">
    <div class="Udetails">
      <p style="text-align:left;padding-top:30%">NAME<br>Write a review</p>
